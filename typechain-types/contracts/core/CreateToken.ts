...
export interface CreateTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(functionFragment: "buyTaxBps", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "buyTaxBps", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "sellTaxBps", data: BytesLike): Result;
...
export interface CreateToken extends BaseContract {
  connect(runner?: ContractRunner | null): CreateToken;
  ...
  buyTaxBps: TypedContractMethod<[], [bigint], "view">;
  ...
  sellTaxBps: TypedContractMethod<[], [bigint], "view">;
